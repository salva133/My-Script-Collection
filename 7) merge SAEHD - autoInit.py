...
def start_merge():
    ...
    values = [
        INTERACTIVE_MERGER, mode, mask_mode, erode_mask, blur_mask,
        motion_blur, output_face_scale, ct_mode, sharpen_mode,
        super_resolution, denoise, bicubic_rescale, degrade_color, workers
    ]
